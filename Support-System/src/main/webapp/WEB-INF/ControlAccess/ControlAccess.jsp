...
<body ng-controller="ControlAccessCtrl">
    <div class="container-fluid">
    	...
    	<div class="panel panel-primary">
            <h3 align="center"><b><font color="black" style="font-family: sans-serif;">Control Access Master</font> </b></h3>            
                    	...
                    	<div class="panel panel-info" style="max-width: 60%;" align="left">                                
                        	<div class="panel-body" >	
				                <div class="form-group">
				                    <label for="controlaccesstype" class="col-sm-4 control-label">Control Access</label>
				                    <div class="col-sm-8">
